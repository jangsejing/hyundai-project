...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final LichLibraryAccessors laccForLichLibraryAccessors = new LichLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>lich</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public LichLibraryAccessors getLich() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForLichLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>timber</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public TimberLibraryAccessors getTimber() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForTimberLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class LichLibraryAccessors extends SubDependencyFactory {

        public LichLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>component</b> with <b>com.linecorp.lich:component</b> coordinates and
         * with version reference <b>lich</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getComponent() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("lich.component");
        }
    ...
    public static class TimberLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>com.jakewharton.timber:timber</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxActivityCompose</b> with value <b>1.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>applicationId</b> with value <b>com.jess.hyundai</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>daggerHilt</b> with value <b>2.50</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lich</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLich() { return getVersion("lich"); }
        ...
        /**
         * Version alias <b>spotlessPlugin</b> with value <b>6.19.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>retrofits</b> which contains the following dependencies:
         * <ul>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getRetrofits() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("retrofits");
        }
    ...
    public static class AndroidxBundleAccessors extends BundleFactory {
        private final AndroidxLifecycleBundleAccessors baccForAndroidxLifecycleBundleAccessors = new AndroidxLifecycleBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);
        ...
        /**
         * Dependency bundle provider for <b>androidx.composes</b> which contains the following dependencies:
         * <ul>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getComposes() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("androidx.composes");
        }

        /**
         * Group of bundles at <b>bundles.androidx.lifecycle</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxLifecycleBundleAccessors getLifecycle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return baccForAndroidxLifecycleBundleAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxLifecycleBundleAccessors extends BundleFactory {

        public AndroidxLifecycleBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>androidx.lifecycle.runtimes</b> which contains the following dependencies:
         * <ul>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getRuntimes() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("androidx.lifecycle.runtimes");
        }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>spotlessPlugin</b>
         * <p>
